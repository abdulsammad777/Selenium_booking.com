...
class BookingReport:
    ...
    def pull_deal_box_attributes(self):
        ...
        for deal_box in self.deal_boxes:
            ...
            # hotel_price = deal_box.find_element_by_class_name(
            #     'bui-price-display__value')
            hotel_price = deal_box.find_element_by_xpath('//div//span[@class="prco-valign-middle-helper"]').text
            # save_button = driver.find_element_by_xpath('//div//button[@type="submit"]')            print(hotel_price)
